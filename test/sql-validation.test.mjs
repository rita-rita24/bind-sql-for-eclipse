...
test('shipped parser, worker and license bundle is reproducible', () => {
  execFileSync(process.execPath, ['scripts/build-validator.mjs', '--check'], { cwd: new URL('../', import.meta.url) });
});
...
function createUI() {
  ...
  return { controller: window.BindSQLValidation, get, workers, tick };
}
